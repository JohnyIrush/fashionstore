			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="table-wrap">
					    ...
					    <tbody>
					      <tr v-for="order in Orders" :index="index">
					        <th scope="row" class="scope" >{{ order.id }}</th>
					        <td>{{ order.status }}</td>
					        <td>{{ order.payment_id }}</td>
					        <td>{{ order.transaction_id }}</td>
					        <td><button class="btn btn-primary" data-bs-toggle="modal" :data-bs-target="'#order-details' + order.id">Order Details</button></td>
                            <orderDetails :order="(order.order)" :orderId="order.id" />
					      </tr>
					    </tbody>
					  </table>
					</div>
