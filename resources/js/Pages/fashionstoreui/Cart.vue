     ...
     <div class="card cart-height">
      ...
      <div class="card-footer">
          <div class="row justify-content-start">
              <a href="/shop" class="btn btn-secondary text-warning col-sm-4"> <i class="fa mr-2 fa-shopping-basket" aria-hidden="true"></i>Go To Shop</a>
          </div>
      </div>
     </div> 
   </div>
    ...
    <div class="col-lg-8">
      ...
      <div  class="card  mb-3">
        <div  class="card-body">
            ...
            <div class="col-md-7 col-lg-9 col-xl-9">
              <div>
                <div class="d-flex justify-content-between">
                  ...
                  <div>
                    <div class="def-number-input number-input safari_only mb-0 w-100">
                      <span v-on:click.prevent="addToCart(product.item.id)"><!--<input type="submit" v-on:click.prevent="addToCart(product.item.id)" value="increase">--> <i class="fa fa-plus"></i></span>
                      <input  :id="'qty'+product.item.id" class="quantity" min="1" name="quantity" :value="product.qty" type="number" readonly>
                      <span v-on:click.prevent="reduceProduct(product.item.id)"><!--<input type="submit" v-on:click.prevent="reduceProduct(product.item.id)" value="reduce">--> <i class="fa fa-minus"></i></span>
                    </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div>
                    <a v-on:click.prevent="removeProduct(product.item.id)" href="#!" type="button" class="card-link-secondary small text-uppercase mr-3"><i
          ...
          <div class="card-footer">
              <div class="row justify-content-start">
                  <a href="/shop" class="btn btn-secondary text-warning col-sm-4"> <i class="fa mr-2 fa-shopping-basket" aria-hidden="true"></i>{{ Items.totalPrice>0 ? 'Continue Shopping' : 'Go To Shop' }} </a>
              </div>
          </div>
          <hr class="mb-5 bg-dark">
          <!--<div class="row mb-4">
